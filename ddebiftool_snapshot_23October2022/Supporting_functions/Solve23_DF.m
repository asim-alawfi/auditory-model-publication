...
par([in.a, in.b, in.tau, in.tau_i, in.D, in.PR, in.df, in.TD,in.lambda,in.theta, in.c, in.m, in.ph1, in.ph2])=...
    [2,    2.8,   0.025,   0.25,   0.015, 15,     0.1,  0.022,   30,       0.5,    5.5, 6, 1, pi];
...
tspan=linspace(0,10,1e6);
dde23_sols=dde23(@(t,y,SD)audi_hopf_rhs(y,SD,SF,sig,par,in),lag,x0,tspan, ddeset('RelTol',1e-7,'Events',@(t,y,z)event(y)));
%%
