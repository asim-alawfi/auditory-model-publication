...
par([in.a, in.b, in.tau, in.tau_i, in.D, in.PR, in.df, in.TD,in.lambda, in.theta, in.c, in.m, in.ph1, in.ph2])=...
    [2,    2.8,   0.0025,   0.25,   0.015, 10,     0.185,  0.022,   30,       3.4,    5.5, 6, 1, pi];
...
tspan=linspace(0,3,1e6);
dde23_the_large=dde23(@(t,y,SD)audi_hopf_rhs(y,SD,SF,sig,par,in),lag,x0,tspan, ddeset('RelTol',1e-3,'AbsTol',1e-3, 'Events',@(t,y,z)event(y)));
%%
...
%% save the file 
%save('sol23_delaylarge_largetheta.mat')
%%
figure(8)
clf; hold on
plot(dde23_the_large.x,dde23_the_large.y(1:4,:),'LineWidth',2)
