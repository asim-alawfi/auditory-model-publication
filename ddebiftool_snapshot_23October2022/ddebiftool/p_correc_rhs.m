function [res,J,ieq]=p_correc_rhs(funcs,method,point,free_par,varargin)
...
if method.extra_condition
    [res_extra,cond_extra]=call_sys_cond(funcs,point,options.pref);
end
