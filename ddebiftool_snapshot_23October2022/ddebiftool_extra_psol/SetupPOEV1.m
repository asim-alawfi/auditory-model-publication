...
%%
function [pfuncs,pbranch,suc]=SetupPOEV1(funcs,branch,ind,varargin)
%% Inputs
%
...
[pfuncs,extra_freepar,initfuncs]=set_POfoldfuncs(funcs,point,branch.method,pass_on{:});
...
pfoldini0=POEV1Init(initfuncs,point,pbranch.method,pass_on{:});
