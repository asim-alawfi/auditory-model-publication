...
ddddD=ch_matrix(funcs,bt.x,bt.parameter,0,'deri',4);
dddddD=ch_matrix(funcs,bt.x,bt.parameter,0,'deri',5);
Deltas={dD, ddD, dddD, ddddD, dddddD};
...
psi0 = @(h) nmfm_psi0(h.v, p0, p1, {dD, ddD, dddD, ddddD, dddddD});
psi1 = @(h) nmfm_psi1(h.v, p0, p1, {dD, ddD, dddD, ddddD, dddddD});
