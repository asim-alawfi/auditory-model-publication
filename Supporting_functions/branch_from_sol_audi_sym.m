...
%
% (c) DDE-BIFTOOL v. 3.2a(126), 05/09/2016
%
% inputs:
%
...
%
%%
function varargout=branch_from_sol_audi_sym(funcs,sol,free_par_ind,parameters,varargin)
default={'degree',4,'intervals',80,'corpar',[],'step',1e-2,'indperiod',[],'stepcond',[],...
...
per0=dde_psol_create('kind','psol','parameter',parameters,'mesh',[],'degree',options.degree,'profile',[],...
    'period',period);   
...
funcs=dde_add_cond('branch_from_sol_audi_sym',funcs,options);
...
varargout=dde_setupoutput(funcs,branch,suc,options.outputfuncs);
end
